<template>
  <div class="purchase_order">
    ...
    <Row>
      ...
      <Button type="primary" @click="getMonthStoresReports">查询</Button>
      </Col>
    </Row>
...
<script>
  import { getMonthStoresReport,searchMonthStoresReport } from '../../../api/api'
  export default {
    data() {
      return {
        options: {
