<template>
  <div class="purchase_order">
    ...
    <Row>
      ...
      <Button type="primary" @click="getMonthBizuserReports">查询</Button>
      </Col>
    </Row>
...
<script>
  import { getMonthBizuserReport,searchMonthBizuserReport } from '../../../api/api'
  export default {
    data() {
      return {
        options: {
