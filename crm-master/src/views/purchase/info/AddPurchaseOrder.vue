<template>
	<div class="purchase_order">
		...
		<Row style="margin: 20px 0;line-height: 32px;">
			...
			<Col span="4">
			<Row>
				<Col span="8" style="text-align: center;"><span style="color: red;">*</span> 进货日期</Col>
				<Col span="16">
			...
			<Col span="4">
			<Row>
				<Col span="8" style="text-align: center;">进货地址</Col>
				<Col span="16">
		...
		<Row style="margin: 20px 0;line-height: 32px;">
				...
				<Col span="4">
			<Row>
				<Col span="8" style="text-align: center;"><span style="color: red;">*</span> 进货数量</Col>
				<Col span="16">
				<Input v-model="params.num"></Input>
				</Col>
			</Row>
			</Col>
			<Col span="4">
			...
			<Col span="4">
			<Row>
				<Col span="8" style="text-align: center;">价格</Col>
				<Col span="16">
				<Input v-model="params.price"></Input>
				</Col>
			</Row>
			</Col>
...
<script>
  ...
  import util from '../../../common/util'
    ...
    addParams(){
         this.$ajax
				.get('/api/CommodityInventory/insert',{params:this.params});
				this.params={
				goodId:'',
				num:'',
				time:'',
