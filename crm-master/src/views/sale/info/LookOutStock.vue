	...
	<div class="purchase_order">
		...
		<Row style="margin: 20px 0;line-height: 32px;">
			...
			<Row>
				...
				<Col span="16">
				<DatePicker disabled type="date" placeholder="请输入日期" v-model='bizDT' :options="options"></DatePicker>
				</Col>
			</Row>
			</Col>
			<Col span="4">
			...
			<Row>
				...
				<Col span="16">
				<Select v-model="warehouseId" disabled>
						...
						<table cellspacing="0" cellpadding="0">
							<tbody>
								<tr class='tr_parent_trash' v-for="(list, key) in table.lists">
									...
									<td class="">
										<Input disabled placeholder="备注" class='modea_input'></Input>
									</td>
									<!--<td class="">
...
<script>
	import { getGoods, allCustomer, getAllOrgs, getAllUsers,editWSBill,getAllStock,wsBillInfo} from '../../../api/api'
	export default {
		mounted() {
...
//						this.$Message.info(res.msg)
          ...
          ticket: sessionStorage.getItem("ticket"),
			...
			getOutStockData(){
				wsBillInfo({
          ticket: sessionStorage.getItem("ticket"),
					id:this.$route.params.look_out_id
				}).then(res=>{
