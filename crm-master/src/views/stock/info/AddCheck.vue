<template>
	<div class="purchase_order">
		...
		<Row style="margin: 20px 0;line-height: 32px;">
			...
			<Col span="4">
			<Row>
				<Col span="6" style="text-align: center;">业务日期</Col>
				<Col span="18">
			...
			<Col span="4">
			<Row>
				<Col span="6" style="text-align: center;">盘点仓库</Col>
				<Col span="18">
				 <Select v-model="checkstockvalue">
          <Option v-for="item in allcheckstockslist" :value="item.value" :key="item.value">{{ item.label }}</Option>
        </Select>
				</Col>
			</Row>
			</Col>
    ...
    <Row>
      ...
      <Row>
        <Col span="2">
          <Col style="text-align: center;">备注</Col>
        </Col>
        <Col span="22">
          <Input v-model="notememo"></Input>
        </Col>
      </Row>
      </Col>
    </Row>
    ...
    <div style="float: right;margin: 30px;">
      <Button type="primary">确定</Button>  <Button type="primary" style="margin-left:30px;">取消</Button>
    </div> -->
    ...
    <table cellspacing="0" cellpadding="0">
      <tbody>
        <tr class='tr_parent_trash' v-for="(list, key) in table.lists">
          ...
          <td class="">
            <Input placeholder="盘点后库存数量" class='modea_input' @on-keyup="sumTotalPrice(key)" v-model='list.goods_count'></Input>
          </td>
          <td class="">{{list.unit_id}}</td>
          <td class="">
            <Input placeholder="盘点后库存金额" class='modea_input' @on-keyup="sumTotalPrice(key)" v-model='list.goods_Money'></Input>
          </td>
          <td class="">
      ...
      /*获取仓库列表*/
        ...
        getAllStock({
          ...
          res.data.forEach((item,index) => {
            ...
            this.allcheckstockslist.push(temp)
          })
        })
      },
        /*获取业务员列表*/
